...
app.use("/matrizProductos", require("./src/routes/matrizProductos"));
app.use("/correos/", require("./src/routes/correos"));
...
app.use("/reportesCalidad/", require("./src/routes/reportesCalidad"));
...
app.use("/rechazos/", require("./src/routes/productosRechazados"));
app.use("/acusesRecibo/", require("./src/routes/acusesRecibo"));
